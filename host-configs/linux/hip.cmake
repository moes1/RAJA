...
###########################################################
execute_process(COMMAND ${ROCM_ROOT_DIR}/hcc/bin/hcc-config --cpp_config OUTPUT_VARIABLE ROCM_CXX_COMPILE_FLAGS)
#execute_process(COMMAND ${ROCM_ROOT_DIR}/hcc/bin/hcc-config --ldflags OUTPUT_VARIABLE ROCM_CXX_LINK_FLAGS)

set(ROCM_CXX_COMPILE_FLAGS "${ROCM_CXX_COMPILE_FLAGS} -ferror-limit=1 -I${ROCM_ROOT_DIR}/hcc/include -Wno-unused-command-line-argument -DHCC_ENABLE_ACCELERATOR_PRINTF" CACHE STRING "")
set(ROCM_CXX_LINK_FLAGS "${ROCM_CXX_LINK_FLAGS} ${ROCM_ARCH_FLAG} ${ROCM_CXX_LIBRARIES}" CACHE STRING "")

###########################################################
# set CMake cache variables
###########################################################
set(CMAKE_CXX_COMPILER "${ROCM_ROOT_DIR}/bin/hipcc" CACHE FILEPATH "ROCm HCC compiler")
